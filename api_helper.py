...
class NorenApiPy(NorenApi):
    def __init__(self):
        NorenApi.__init__(self, host='http://192.168.54.40:9990/DealerWClient', websocket='ws://192.168.54.40:5552/NorenWS/', eodhost='http://192.168.54.40:5000/chartApi/getdata/')
